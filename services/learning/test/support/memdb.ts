...
function seed(db: IMemoryDb): void {
  db.public.none(`
    ...
    INSERT INTO article_versions (id, article_id, version_no, body_doc, state, created_by, approved_by, published_at)
    VALUES ('${IDS.publishedVersion}', '${IDS.article}', 3,
            '{"tipo":"doc","contenido":[{"tipo":"parrafo","contenido":[{"tipo":"texto","texto":"Cuerpo publicado"}]}]}'::jsonb,
            'publicado', '${IDS.editor}', '${IDS.user}', now()),
           ('${IDS.draftVersion}', '${IDS.draftArticle}', 1,

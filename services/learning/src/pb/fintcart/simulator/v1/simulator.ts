...
export const SimulatorServiceService = {
  /**
   ...
   */
  compute: {
    path: "/fintcart.simulator.v1.SimulatorService/Compute",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ComputeRequest) => Buffer.from(ComputeRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ComputeRequest.decode(value),
    responseSerialize: (value: ComputeResponse) => Buffer.from(ComputeResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ComputeResponse.decode(value),
  },
  /** Historial de simulaciones por usuario (FR-022). */
  listHistory: {
    path: "/fintcart.simulator.v1.SimulatorService/ListHistory",
    requestStream: false,
    responseStream: false,
...
export interface SimulatorServiceServer extends UntypedServiceImplementation {
  /**
   * Ejecuta una simulación y persiste el historial (FR-019..FR-022).
   * Invocada por el Orquestador para permitir el evento de auditoría (D-03).
   */
...
export interface SimulatorServiceClient extends Client {
  ...
  compute(
    ...
    callback: (error: ServiceError | null, response: ComputeResponse) => void,
  ): ClientUnaryCall;
  compute(
    request: ComputeRequest,
    metadata: Metadata,
...
export const SimulatorServiceClient = makeGenericClientConstructor(
  SimulatorServiceService,
  "fintcart.simulator.v1.SimulatorService",
) as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): SimulatorServiceClient;
  service: typeof SimulatorServiceService;
  serviceName: string;
};
